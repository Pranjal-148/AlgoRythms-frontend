    ...
    <Router>
      <div className="min-h-screen bg-[#121212] text-white font-sans selection:bg-[#1db954] selection:text-black relative antialiased">
        ...
        <button
          ...
          className="fixed bottom-6 right-6 z-[9999] flex items-center gap-2 px-4 py-2.5 bg-white/5 backdrop-blur-xl border border-white/10 rounded-full text-white text-sm font-semibold tracking-wide hover:bg-white/10 hover:border-white/20 transition-all duration-300 shadow-2xl hover:scale-105"
        >
